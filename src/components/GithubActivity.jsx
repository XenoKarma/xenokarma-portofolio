...
const stats = [
  ...
  { value: '3+', label: 'Years Learning', icon: 'M4.26 10.147a60.438 60.438 0 0112.35-3.444L15.75 3.5 4.26 10.147zM4.26 10.147v9.689m0-9.689L15.75 3.5m0 0l.588 2.143m0 0a60.3 60.3 0 00-4.23 1.128m4.23-1.128L21 7.5M4.26 19.853a60.1 60.1 0 0012.35 3.445M4.26 19.853L15.75 21m0 0l-.588-2.143m0 0a60.438 60.438 0 01-12.35-3.444m12.35 3.444L21 16.5' },
  { value: '∞', label: 'Curiosity', icon: 'M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.455 2.456L21.75 6l-1.036.259a3.375 3.375 0 00-2.455 2.456zM16.894 20.567L16.5 21.75l-.394-1.183a2.25 2.25 0 00-1.423-1.423L13.5 18.75l1.183-.394a2.25 2.25 0 001.423-1.423l.394-1.183.394 1.183a2.25 2.25 0 001.423 1.423l1.183.394-1.183.394a2.25 2.25 0 00-1.423 1.423z' },
]
